...
est310_mtdlayout_8M=mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,6336k(rootfs),1472k(kernel),64k(art)ro,7744k@0x50000(firmware)
#est310_mtdlayout_16M=mtdparts=spi0.0:256k(u-boot)ro,64k(u-boot-env)ro,14528k(rootfs),1472k(kernel),64k(art)ro,16000k@0x50000(firmware)
...
$(eval $(call SingleProfile,AthLzma,64k,EST310_8M,EST310-8M,EST310,ttyS0,115200,$$(EST310_mtdlayout_8M),RKuImage))
#$(eval $(call SingleProfile,AthLzma,64k,EST310_16M,est310-16M,EST310,ttyS0,115200,$$(est310_mtdlayout_16M),RKuImage))
